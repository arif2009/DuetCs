...
//===========================================================================//
    ...
    */
(function($){ 
$.fn.htmlbox=function(options,image_dir){
    // START: Settings
	...
	var d={
		...
		idir:image_dir+"reach_text_box/images/",// HtmlBox Image Directory, This is needed for the images to work
...
//		   }
	...
	this.cmd = function(cmd,arg1){
	   ...
	   if(cmd==="code"){
		   ...
		   var about = "<p style='margin:2px;'>1. You can post Bangla(Unicode) or English.</p>";
		   about += "<p style='margin:2px;'>2. For writing bangla you can use Avro.</p>";
                   about += "<p style='margin:2px;'>3. For post code select a SYNTAX, related your code.</p>";
                   about += "<p style='margin:2px;padding-left:20px;'> You may also use this site :</p>";
                   about += "<p style='margin:2px;padding-left:20px;'><a href='http://www.google.com/transliterate/bengali' target='_blank'><b>Google Transliteration</b></a></p>";
                   about += "<p style='margin:2px;padding-left:20px;'><a href='http://scripts.ofhas.in/bim/' target='_blank'><b>Phonetic and Unijoy Bangla</b></a></p>";
                   about += "<p style='margin:2px;'>4. You insert picture by using real Link. After inserting you also resize this picture.</p>";
                   about += "<p style='margin:2px;padding-left:20px;'> You may also use this site for creating real link of a picture : <a href='https://droplr.com' target='_blank'><b>https://droplr.com</b></a></p>";
		   ...
		   var html = '<table cellspacing="3" cellpadding="0" width="100%" height="100%"  style="background:#D7E3F2;border:2px solid #7E9DB9;font-family:verdana;font-size:12px;">';
                   html += '<tr><td align="center" valign="middle" height="30" style="font-size:16px;"><b>Instruction\'s</b></td></tr>';
                   ...
                   html += '<tr><td height="20"><table width="100%" style="font-family:verdana;font-size:10px;"><tr><td align="left">Copyright&copy;2012 DUETCS<br>All right reserved!</td><td align="right"><button style="width:60px;height:24px;font-family:verdana;font-size:11px;" onclick="$(\'#'+d.id+'_about\').fadeOut(500);">Close</button></td></tr></table></td></tr>';
                   html += '</table>';
